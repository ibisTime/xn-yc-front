                        ...
                        if (list.length) {
                            ...
                            list.forEach(function(d) {
                                html += '<li class="ptb8 clearfix b_bd_b">' +
                                    ...
                                    '<p class="t_red ptb4">';
                                if(d.price2){
                                    html += '<span class="s_12 t_red">'+ base.formatMoney(d.price2) +'橙券</span>';
                                }
                                ...
                                html += '</p>';
                                if (d.originalPrice) {
                                    html += '<p class="s_10"  style="text-decoration: line-through;">市场参考价：<span>' + base.formatMoney(d.originalPrice) + '</span>元</p>';
                                }
                                html += '</div></a></li>';
                            });
                            removeLoading();
